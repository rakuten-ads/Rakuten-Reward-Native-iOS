...
MAPPING = {
    ...
    "doc/js-extension.md": [
        "docs/ios/js-extension.md",
    ],
    "doc/api-reference.md": [
        "docs/ios/api-reference.md",
        "docs/ios/configuration.md",
        "docs/ios/app-language.md",
        "docs/ios/debugging.md",
    ],
    "doc/objective-c.md": [
        "docs/ios/api-reference.md",
    ],
    ...
    # JA
    "doc/ja/README.md": [
        "docs/ja/ios/index.md",
    ],
    "doc/ja/authentication.md": [
        "docs/ja/ios/integration.md",
    ],
    "doc/ja/missions.md": [
        "docs/ja/ios/mission.md",
    ],
    "doc/ja/user-consent.md": [
        "docs/ja/ios/consent.md",
    ],
    "doc/ja/portal.md": [
        "docs/ja/ios/ui.md",
    ],
    "doc/ja/js-extension.md": [
        "docs/ja/ios/js-extension.md",
    ],
    "doc/ja/api-reference.md": [
        "docs/ja/ios/api-reference.md",
        "docs/ja/ios/configuration.md",
        "docs/ja/ios/app-language.md",
        "docs/ja/ios/debugging.md",
    ],
    "doc/ja/FAQ/FAQ.md": [
        "docs/ja/ios/faq.md",
    ],
...
# Maps source file -> list of Confluence iOS page dicts {id, title}
CONFLUENCE_MAPPING = {
    "README.md": [
        {"id": "6863539183", "title": "3 - Setup | 🍏 iOS"},
        {"id": "6863539187", "title": "4 - Initialization | 🍏 iOS"},
    ],
    "doc/authentication.md": [
        {"id": "6863539187", "title": "4 - Initialization | 🍏 iOS"},
        {"id": "6863539191", "title": "5 - Authentication | 🍏 iOS"},
    ],
    "doc/missions.md": [
        {"id": "6863539199", "title": "6 - Missions and Points | 🍏 iOS"},
    ],
    "doc/user-consent.md": [
        {"id": "6863539205", "title": "7 - Consent | 🍏 iOS"},
    ],
    "doc/portal.md": [
        {"id": "6863539226", "title": "8 - Portal UI | 🍏 iOS"},
    ],
    "doc/js-extension.md": [
        {"id": "6863539158", "title": "10 - JavaScript Extension | 🍏 iOS"},
    ],
    "doc/sps.md": [
        {"id": "6863539244", "title": "9 - Super Point Screen Ads | 🍏 iOS"},
    ],
    "doc/api-reference.md": [
        {"id": "6863539167", "title": "11 - Configuration | 🍏 iOS"},
        {"id": "6863539173", "title": "12 - API Data | 🍏 iOS"},
...
CONFLUENCE_REVIEW_PROMPT = """You are a technical documentation editor for the Rakuten Reward iOS SDK.
...
def update_jazzy_link():
    """Update the iOS API Doc (jazzy) URL version in vitepress config.mjs to match README version."""
    readme = open("README.md", encoding="utf-8").read()
    version_match = re.search(r'badge/version-(\d+\.\d+\.\d+)-', readme)
    if not version_match:
        print("  SKIP: version badge not found in README.md")
        return
    ...
    updated = re.sub(
        r'(https://rakuten-ads\.github\.io/products/mission/iOS/Native/jazzy/)\d+\.\d+\.\d+(/index\.html)',
        rf'\g<1>{version}\g<2>',
        config
    )

    if updated == config:
        print("  jazzy link already up to date in config.mjs")
        return

    with open(config_path, "w", encoding="utf-8") as f:
        f.write(updated)
    print(f"  updated: docs/.vitepress/config.mjs (jazzy → {version})")
...
def create_confluence_report_page(version, sections_html):
    import requests
    title = f"iOS {version} Guide Update"
    body = (
