Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/rakuten-ads/Rakuten-Reward-Native-iOS/releases/download/2.3.0/RakutenRewardNativeSDK-2.3.0-6.framework.zip' }
