Pod::Spec.new do |s|  
    ...
    s.version           = '2.0.1-beta5-universal'
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/rakuten-ads/Rakuten-Reward-Native-iOS/releases/download/2.0.1-beta5/RakutenRewardNativeSDK-2.0.1-beta5-2.framework.zip' }
