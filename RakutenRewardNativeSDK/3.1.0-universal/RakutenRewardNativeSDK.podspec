Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/rakuten-ads/Rakuten-Reward-Native-iOS/releases/download/3.1.0/RakutenRewardNativeSDK-3.1.0-8.framework.zip' }
