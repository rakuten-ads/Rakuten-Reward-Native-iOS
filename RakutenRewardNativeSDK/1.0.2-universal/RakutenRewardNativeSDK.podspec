Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/rakuten-ads/Rakuten-Reward-Native-iOS/releases/download/1.0.2/RakutenRewardNativeSDK-1.0.2-2.framework.zip' }
