Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/rakuten-ads/Rakuten-Reward-Native-iOS/releases/download/0.1.0-beta40/RakutenRewardNativeSDK-0.1.0-40.framework.zip' }
