...
| **RAE**（楽天 User SDK） | RAEトークンを使用する楽天 User SDK を利用している場合。 | **非推奨** — 2025年末までにRIDへ移行してください |
...
クライアント ID のスコープ設定に関するサポートや、アクセストークンに関するお問い合わせは、お問い合わせください。

---

> [![en](../images/en.png)](../authentication.md) English version
